...
public class paintJob{
	...
	final static double gallonsPerSquareFeet = 115;
	...
	public static void main (String[] args){
		...
		System.out.println("The cost of the entire job is " + df.format((getTotalCost(laborCost, paintCost))));
		System.exit(0);
	}
	...
	public static double calculatePaintNeeded(double squareFootage)
	{
		...
		return squareFootage / gallonsPerSquareFeet;
	}
