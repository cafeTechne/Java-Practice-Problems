...
public abstract class BankAccount implements Serializable{
	 ...
	 */
	public BankAccount(double balance, double annualInterestRate)throws InvalidDepositAmount{
	...
	public BankAccount(double balance, double annualInterestRate, double monthlyServiceCharges)throws InvalidDepositAmount{
		this.deposit(balance);
		this.annualInterestRate = annualInterestRate;
	...
	public void withdraw(double withdrawalAmount) throws InvalidWithdrawalAmount {
		//if withdrawal amount is less than or equal to 0, or greater than the current balance, or greater than $10,000.
